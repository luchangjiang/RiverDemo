...
public class Aggregation {
	 ...
	 */
	public Aggregation(JavaSparkContext sparkContext) {
	...
	public void sum() {
		...
		System.out.println("(Aggregation)Data: " + rddData.collect() + "\n(Aggregation)Sum using Aggregate Op = " + sum);
	...
	public void sumAndProduct() {
		...
		System.out.println("(Aggregation)Data: " + rddData.collect() + "\n(Aggregation)Sum and Product using Aggregate Op = " + result);
