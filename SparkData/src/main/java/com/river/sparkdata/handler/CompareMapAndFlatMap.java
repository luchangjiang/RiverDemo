...
public class CompareMapAndFlatMap {
	 ...
	 */
	public CompareMapAndFlatMap(JavaSparkContext sparkContext) {
	...
	public void compare() {
		...
		System.out.println("(ComparesMapAndFlatMap)List of String: " + data);

		/* Printing the records in JavaRDD lines */
		System.out.println("(ComparesMapAndFlatMap)collect:" + lines.collect());
		/*
		 * Using Spark FlatMap Transformation and splitting each of the records
		 * in JavaRDD lines.
		 */
		JavaRDD<String> lineflatMap = lines.flatMap(s -> Arrays.asList(s.split(" ")));

		/* Printing FlatMap Output */
		System.out.println("(ComparesMapAndFlatMap)FlatMap Output: " + lineflatMap.collect());
		...
		/* Printing Map Output */
		System.out.println("(ComparesMapAndFlatMap)Map Output = \n" + mapOut);
