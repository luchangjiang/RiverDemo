...
public class Reduce {
	 ...
	 */
    public Reduce(JavaSparkContext sparkContext) {
	...
	public void sum() {
		...
		System.out.println("(Reduce)Data: " + rddData.collect() + "\n(Reduce)Sum using Reduce Op = " + sum);
	...
	public void shortestLine() {
		...
		System.out.println("(Reduce)File Content:\n" + carData.collect() + "\n\nShortest Line = " + shortest);
