...
public class ArrayData {
	 ...
	 */
	public ArrayData(JavaSparkContext sparkContext) {
	...
	public void callArrayData() {
		...
		System.out.println("(ArrayData)Data = " + rddData.collect());

		/* Printing distinct data in rddData */
		System.out.println("(ArrayData)Distinct Data = " + rddData.distinct().collect());

		/* Printing first n=3 records in rddData */
		System.out.println("(ArrayData)First Three Records = " + rddData.take(3));

		/* Printing first record in rddData */
		System.out.println("(ArrayData)First Record = " + rddData.first());

		/* Printing the count of records in rddData */
		System.out.println("(ArrayData)Count = " + rddData.count());

		/* Printing the count of distinct records in rddData */
		System.out.println("(ArrayData)Distinct Count = " + rddData.distinct().count());
