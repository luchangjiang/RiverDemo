/**
 * SparkDataApplication
 */
package com.river.sparkdata;

import com.river.sparkdata.constant.Constants;
import com.river.sparkdata.handler.*;
import org.apache.spark.api.java.JavaRDD;
import org.apache.spark.api.java.JavaSparkContext;


/**
 * SparkDataApplication Class. To run Spark Java Programming Examples.
 * 
 * @author neeraj
 *
 */
public class SparkDataApplication {
	/**
	 * SparkDataApplication Class implements the main method to test and run Spark Java
	...
	public static void main(String[] args) {
		...
		exFileData.callFileData(Constants.CARS_FILE);
		...
		JavaRDD<String> carData = hdfsData.readHDFS("hdfs://localhost:9000/spark/cars.csv")
				.filter(x -> x.contains("audi"));
		hdfsData.saveToHDFS(carData, "hdfs://localhost:9000/spark/audi");
