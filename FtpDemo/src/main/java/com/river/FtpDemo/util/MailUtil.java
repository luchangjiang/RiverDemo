...
public class MailUtil {
    ...
    public static void main(String[] args) throws Exception {
        String userName = "luchangjiang@huawei.com"; // 发件人邮箱
        String password = "Walsin@91068"; // 发件人密码
        String smtpHost = "smtpscn.huawei.com"; // 邮件服务器

        String to = "20207075@qq.com"; // 收件人，多个收件人以半角逗号分隔
        String cc = "luchangjiang@huawei.com"; // 抄送，多个抄送以半角逗号分隔
        String subject = "这是邮件的主题"; // 主题
        String body = "这是邮件的正文"; // 正文，可以用html格式的哟
        List<String> attachments = Arrays.asList("D:\\tmp\\es1.yml", "D:\\tmp\\es2.yml"); // 附件的路径，多个附件也不怕

        MailUtil email = MailUtil.entity(smtpHost, userName, password, to, cc, subject, body, attachments);
    ...
    public static MailUtil entity(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,
                               List<String> attachments) {
        return new MailUtil(smtpHost, sendUserName, sendUserPass, to, cc, mailSubject, mailBody, attachments);
    }
     ...
     * @return
     */
    public static MailUtil defaultEntity(String to, String cc, String subject, String body, List<String> attachments) {
        return new MailUtil(defaultSmtpHost, defaultSenderName, defaultSenderPass, to, cc, subject, body, attachments);
    }
